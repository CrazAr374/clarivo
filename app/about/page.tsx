...
const AboutPage = () => {
  const team = [
    ...
    },
    {
      ...
      linkedin: 'https://www.linkedin.com/in/sarthak-nandre/',
      github: '#',
      email: '#'
    },
  ]
            ...
            {team.map((member, index) => (
              ...
              >
                <div className="glass-morphism rounded-2xl p-8 text-center h-full transition-all duration-300 hover:bg-white/15">
                  {/* Avatar */}
                  <div className="mb-6">
                    <div className="w-32 h-32 mx-auto rounded-full overflow-hidden bg-gradient-to-br from-neutral-light/10 to-neutral-light/5 p-1">
                      <Image
                        src={member.image}
                      ...
                      <div className={`w-full h-full rounded-full bg-gradient-to-br ${member.gradient} flex items-center justify-center text-white text-3xl font-bold`} style={{ display: 'none' }}>
